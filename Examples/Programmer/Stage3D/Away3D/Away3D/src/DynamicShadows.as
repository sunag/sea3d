package
{
	...
	public class DynamicShadows extends Sprite
	{
		...
		public function DynamicShadows()
		{
			/**
			 * Basic config.
			 * */
			...
			//config.shadowMethod = ShadowMethod.CASCADE; // better quality for big scene
			...
			sea3d.load(new URLRequest("../assets/DynamicShadows.sea"));
