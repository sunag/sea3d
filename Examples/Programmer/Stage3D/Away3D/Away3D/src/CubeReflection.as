package
{
	...
	public class CubeReflection extends Sprite
	{
		...
		public function CubeReflection()
		{
			/**
			 * Basic config.
			 * */
			...
			sea3d.load(new URLRequest("../assets/CubeReflection.sea"));						
		}
		...
		{		
			...
			for each(var cubeReflection:CubeReflectionTextureTarget in renderToTextureModule.cubeReflections)
			{
				cubeReflection.render(view);
			}
