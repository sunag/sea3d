...
SEA3D.Stream.prototype.readScriptList=function(a){for(var b=[],c=this.readUByte(),d=0;d<c;){var e=this.readUByte(),f={};f.priority=e&1|e&2;if(e&4){var g=this.readUByte();f.params={};for(var h=0;h<g;h++){var k=this.readUTF8Tiny();f.params[k]=this.readObject(a)}}e&8&&(f.method=this.readUTF8Tiny());f.tag=a.getObject(this.readUInt());b[d++]=f}return b};SEA3D.Stream.prototype.readObject=function(a){return this.readToken(this.readUByte(),a)};
...
c.getObject(b.readUInt());h.target=c.getObject(b.readUInt());break;case SEA3D.Actions.LOOK_AT:h.source=c.getObject(b.readUInt());h.target=c.getObject(b.readUInt());break;case SEA3D.Actions.PLAY_SOUND:h.sound=c.getObject(b.readUInt());h.offset=b.readUInt();break;case SEA3D.Actions.PLAY_ANIMATION:h.object=c.getObject(b.readUInt());h.name=b.readUTF8Tiny();break;case SEA3D.Actions.FOG:h.color=b.readUInt24();h.min=b.readFloat();h.max=b.readFloat();break;case SEA3D.Actions.ENVIRONMENT:h.texture=c.getObject(b.readUInt());
break;case SEA3D.Actions.ENVIRONMENT_COLOR:h.color=b.readUInt24F();break;case SEA3D.Actions.CAMERA:h.camera=c.getObject(b.readUInt());break;case SEA3D.Actions.SCRIPTS:h.scripts=b.readScriptList(c);break;case SEA3D.Actions.CLASS_OF:h.classof=c.getObject(b.readUInt());break;case SEA3D.Actions.ATTRIBUTES:h.attributes=c.getObject(b.readUInt());break;default:console.log('Action "'+e+'" not found.')}b.position=g+f}};SEA3D.Actions.SCENE=0;SEA3D.Actions.ENVIRONMENT_COLOR=1;SEA3D.Actions.ENVIRONMENT=2;
...
SEA3D.Morph=function(a,b,c){SEA3D.GeometryBase.call(this,a,b,c);a=0!=(this.attrib&2);c=0!=(this.attrib&4);var d=b.readUShort();this.node=[];for(var e=0;e<d;e++){var f=b.readUTF8Tiny(),g,h;a&&(g=b.readFloatArray(this.length));c&&(h=b.readFloatArray(this.length));this.node[e]={vertex:g,normal:h,name:f}}};SEA3D.Morph.prototype=Object.create(SEA3D.GeometryBase.prototype);SEA3D.Morph.prototype.constructor=SEA3D.Morph;SEA3D.Morph.prototype.type="mph";
...
b.readAnimationList(c));this.depthMask=0==(this.attrib&256);this.depthTest=0==(this.attrib&512);a=b.readUByte();for(var d=0;d<a;++d){var e=b.readUShort(),f=b.readUShort(),g=b.position,h,k;switch(e){case SEA3D.Material.PHONG:h={ambientColor:b.readUInt24(),diffuseColor:b.readUInt24(),specularColor:b.readUInt24(),specular:b.readFloat(),gloss:b.readFloat()};break;case SEA3D.Material.PHYSICAL:h={color:b.readUInt24(),roughness:b.readFloat(),metalness:b.readFloat()};break;case SEA3D.Material.ANISOTROPIC:break;
case SEA3D.Material.COMPOSITE_TEXTURE:h={composite:c.getObject(b.readUInt())};break;case SEA3D.Material.DIFFUSE_MAP:h={texture:c.getObject(b.readUInt())};break;case SEA3D.Material.SPECULAR_MAP:h={texture:c.getObject(b.readUInt())};break;case SEA3D.Material.NORMAL_MAP:h={texture:c.getObject(b.readUInt())};break;case SEA3D.Material.REFLECTION:case SEA3D.Material.FRESNEL_REFLECTION:h={texture:c.getObject(b.readUInt()),alpha:b.readFloat()};e==SEA3D.Material.FRESNEL_REFLECTION&&(h.power=b.readFloat(),
h.normal=b.readFloat());break;case SEA3D.Material.REFRACTION:h={texture:c.getObject(b.readUInt()),alpha:b.readFloat(),ior:b.readFloat()};break;case SEA3D.Material.RIM:h={color:b.readUInt24(),strength:b.readFloat(),power:b.readFloat(),blendMode:b.readBlendMode()};break;case SEA3D.Material.LIGHT_MAP:h={texture:c.getObject(b.readUInt()),channel:b.readUByte(),blendMode:b.readBlendMode()};break;case SEA3D.Material.DETAIL_MAP:h={texture:c.getObject(b.readUInt()),scale:b.readFloat(),blendMode:b.readBlendMode()};
break;case SEA3D.Material.CEL:h={color:b.readUInt24(),levels:b.readUByte(),size:b.readFloat(),specularCutOff:b.readFloat(),smoothness:b.readFloat()};break;case SEA3D.Material.TRANSLUCENT:h={translucency:b.readFloat(),scattering:b.readFloat()};break;case SEA3D.Material.BLEND_NORMAL_MAP:k=b.readUByte();h={texture:c.getObject(b.readUInt()),secondaryTexture:c.getObject(b.readUInt())};k&1?(h.offsetX0=b.readFloat(),h.offsetY0=b.readFloat(),h.offsetX1=b.readFloat(),h.offsetY1=b.readFloat()):h.offsetX0=h.offsetY0=
h.offsetX1=h.offsetY1=0;h.animate=k&2;break;case SEA3D.Material.MIRROR_REFLECTION:h={texture:c.getObject(b.readUInt()),alpha:b.readFloat()};break;case SEA3D.Material.AMBIENT_MAP:h={texture:c.getObject(b.readUInt())};break;case SEA3D.Material.ALPHA_MAP:h={texture:c.getObject(b.readUInt())};break;case SEA3D.Material.EMISSIVE:h={color:b.readUInt24()};break;case SEA3D.Material.EMISSIVE_MAP:h={texture:c.getObject(b.readUInt())};break;case SEA3D.Material.ROUGHNESS_MAP:case SEA3D.Material.METALNESS_MAP:h=
{texture:c.getObject(b.readUInt())};break;case SEA3D.Material.VERTEX_COLOR:h={blendMode:b.readBlendMode()};break;case SEA3D.Material.WRAP_LIGHTING:h={color:b.readUInt24(),strength:b.readFloat()};break;case SEA3D.Material.COLOR_REPLACE:k=b.readUByte();h={red:b.readUInt24(),green:b.readUInt24(),blue:b.readUInt24F()};k&1&&(h.mask=c.getObject(b.readUInt()));k&2&&(h.alpha=b.readFloat());break;case SEA3D.Material.REFLECTION_SPHERICAL:h={texture:c.getObject(b.readUInt()),alpha:b.readFloat()};break;case SEA3D.Material.REFLECTIVITY:k=
b.readUByte();h={strength:b.readFloat()};k&1&&(h.mask=c.getObject(b.readUInt()));break;case SEA3D.Material.CLEAR_COAT:h={strength:b.readFloat(),roughness:b.readFloat()};break;default:console.warn("SEA3D: MaterialTechnique not found:",e.toString(16));b.position=g+f;continue}h.kind=e;this.technique.push(h);this.tecniquesDict[e]=h;b.position=g+f}};SEA3D.Material.PHONG=0;SEA3D.Material.COMPOSITE_TEXTURE=1;SEA3D.Material.DIFFUSE_MAP=2;SEA3D.Material.SPECULAR_MAP=3;SEA3D.Material.REFLECTION=4;
...
[];this.animationsData={};if(!this.geometry||void 0!==this.geometry.animations){this.clips=this instanceof THREE.SEA3D.Animator?this.clips:this.geometry.animations;for(a=0;a<this.clips.length;a++)this.addAnimation(this.clips[a]);return this}},addAnimation:function(a){var b=a.name;this.animations[b]=a;this.animationsData[b]={};this.animationsIndex.push(a);this.mixer.clipAction(a);return this},removeAnimation:function(a){var b=a.name;delete this.animations[b];delete this.animationsData[b];this.animationsIndex.splice(this.animationsIndex.indexOf(a),
...
THREE.SEA3D.prototype.readAnimation=function(a){for(var b=[],c=1E3/a.frameRate/1E3,d=0;d<a.sequence.length;d++){for(var e=a.sequence[d],f=[],g=0;g<a.dataList.length;g++){var h=a.dataList[g],k,m,l,q=h.data;l=e.start*h.blockSize;k=l+e.count*h.blockSize;var r=e.intrpl?THREE.InterpolateLinear:!1,s=null;switch(h.kind){case SEA3D.Animation.POSITION:s=".position";break;case SEA3D.Animation.ROTATION:s=".quaternion";break;case SEA3D.Animation.SCALE:s=".scale";break;case SEA3D.Animation.COLOR:s=".color";break;
case SEA3D.Animation.MULTIPLIER:s=".intensity";break;case SEA3D.Animation.FOV:s=".fov"}if(s)switch(h.type){case SEA3D.Stream.BYTE:case SEA3D.Stream.UBYTE:case SEA3D.Stream.INT:case SEA3D.Stream.UINT:case SEA3D.Stream.FLOAT:case SEA3D.Stream.DOUBLE:case SEA3D.Stream.DECIMAL:l=q.subarray(l,k);m=new Float32Array(l.length);for(k=h=0;k<m.length;k++)m[k]=h,h+=c;f.push(new THREE.VectorKeyframeTrack(s,m,l,r));break;case SEA3D.Stream.VECTOR3D:l=q.subarray(l,k);m=new Float32Array(l.length/h.blockSize);for(k=
h=0;k<m.length;k++)m[k]=h,h+=c;f.push(new THREE.VectorKeyframeTrack(s,m,l,r));break;case SEA3D.Stream.VECTOR4D:l=q.subarray(l,k);m=new Float32Array(l.length/h.blockSize);for(k=h=0;k<m.length;k++)m[k]=h,h+=c;f.push(new THREE.QuaternionKeyframeTrack(s,m,l,r));break;case SEA3D.Stream.INT24:case SEA3D.Stream.UINT24:l=new Float32Array(3*(k-l));m=new Float32Array(l.length/3);for(k=h=0;k<m.length;k++)l[3*k]=(q[k]>>16&255)/255,l[3*k+1]=(q[k]>>8&255)/255,l[3*k+2]=(q[k]&255)/255,m[k]=h,h+=c;f.push(new THREE.VectorKeyframeTrack(s,
...
e=new THREE.MultiMaterial(e)}else e=a.material[0].tag,e.skinning=void 0!=f,e.morphTargets=c,e.morphNormals=k,e.vertexColors=a.geometry.color?THREE.VertexColors:THREE.NoColors;f?(b=new THREE.SEA3D.SkinnedMesh(d,e,this.config.useVertexTexture),this.config.autoPlay&&g&&b.play(0)):h?(b=new THREE.SEA3D.VertexAnimationMesh(d,e,h.frameRate),this.config.autoPlay&&b.play(0)):b=new THREE.SEA3D.Mesh(d,e);b.name=a.name;b.castShadow=a.castShadows;b.receiveShadow=a.material?a.material[0].receiveShadows:!0;this.domain.meshes=
...
THREE.SEA3D.prototype.readCubeMap=function(a){var b=this.toFaces(a.faces),c=new THREE.CubeTexture([]),d=0;c.name=a.name;c.flipY=!1;c.format=THREE.RGBFormat;for(var e=function(){6==++d&&(c.needsUpdate=!0,this.config.async||(this.file.resume=!0))}.bind(this),f=0;f<b.length;++f){var g=new Image;g.onload=e;g.src=this.bufferToTexture(b[f].buffer);c.images[f]=g}this.config.async||(this.file.resume=!1);this.domain.cubemaps=this.cubemaps=this.cubemaps||[];this.cubemaps.push(this.objects["cmap/"+a.name]=a.tag=
...
THREE.SEA3D.prototype.getSkeletonAnimation=function(a,b){if(a.tag)return a.tag;for(var c=[],d=1E3/a.frameRate/1E3,e=0;e<a.sequence.length;e++){for(var f=a.sequence[e],g=f.start,h=g+f.count,k={name:f.name,fps:a.frameRate,length:d*f.count,hierarchy:[]},m=a.numJoints,l=a.raw,q=0;q<m;q++){for(var r={parent:b.joint[q].parentIndex,keys:[]},s=r.keys,t=0,p=g;p<h;p++){var n=p*m*7+7*q;s.push({time:t,pos:[l[n],l[n+1],l[n+2]],rot:[l[n+3],l[n+4],l[n+5],l[n+6]],scl:[1,1,1]});t+=d}k.hierarchy[q]=r}g=THREE.AnimationClip.parseAnimation(k,
b.tag);g.loop=f.repeat;g.timeScale=1;c.push(g)}return a.tag=c};
THREE.SEA3D.prototype.readVertexAnimation=function(a){var b={position:[]},c=[],d=[],e,f,g;if(THREE.Float32BufferAttribute)for(e=0,g=a.frame.length;e<g;e++)f=a.frame[e],b.position[e]=new THREE.Float32BufferAttribute(f.vertex,3),f.normal&&(b.normal=b.normal||[],b.normal[e]=new THREE.Float32BufferAttribute(f.normal,3)),c[e]={name:e};else for(e=0,g=a.frame.length;e<g;e++)f=a.frame[e],b.position[e]=new THREE.Float32Attribute(new Float32Array(f.vertex),3),f.normal&&(b.normal=b.normal||[],b.normal[e]=new THREE.Float32Attribute(new Float32Array(f.normal),
3)),c[e]={name:e};for(e=0;e<a.sequence.length;e++){g=a.sequence[e];var h=[];for(f=0;f<g.count;f++)h[f]=c[g.start+f];f=THREE.AnimationClip.CreateFromMorphTargetSequence(g.name,h,a.frameRate);f.loop=g.repeat;f.timeScale=1;d.push(f)}a.tag={attribs:b,targets:c,animations:d}};
...
THREE.SEA3D.prototype.updateAnimationSet=function(a){var b=new THREE.Matrix4,c=new THREE.Matrix4,d=new THREE.Vector3,e=new THREE.Quaternion,f=new THREE.Vector3,g=new THREE.Vector3,h=new THREE.Quaternion,k=new THREE.Vector3;return function(a){var l=a.animation.animationSet,q=l.animations;if(!l.flip||q.length){for(var r=q[0].dataList,q=[],s=0;s<r.length;s++){var t=r[s],p=r[s].data,n=t.kind,t=p.length/t.blockLength;switch(n){case SEA3D.Animation.POSITION:case SEA3D.Animation.ROTATION:case SEA3D.Animation.SCALE:q.push({kind:n,
...
4*a,f.set(p[n],p[n+1],p[n+2])}b.compose(d,e,f);this.flipMatrixScale(b,!1,c);b.decompose(g,h,k);for(r=0;r<q.length;r++)switch(p=q[r].raw,n=q[r].kind,n){case SEA3D.Animation.POSITION:n=3*a;p[n]=g.x;p[n+1]=g.y;p[n+2]=g.z;break;case SEA3D.Animation.ROTATION:n=4*a;p[n]=h.x;p[n+1]=h.y;p[n+2]=h.z;p[n+3]=h.w;break;case SEA3D.Animation.SCALE:n=3*a,p[n]=k.x,p[n+1]=k.y,p[n+2]=k.z}}l.flip=!0}}}();
...
THREE.SEA3D.prototype.readSkeleton=function(a){var b=new THREE.Matrix4,c=new THREE.Matrix4,d=new THREE.Matrix4,e=new THREE.Vector3,f=new THREE.Quaternion;return function(a){for(var h=[],k=a.sea3d.config.legacy,m=0;m<a.joint.length;m++){var l=a.joint[m];b.elements=l.inverseBindMatrix;c.getInverse(b);k&&this.flipMatrixBone(c);-1<l.parentIndex&&(b.elements=a.joint[l.parentIndex].inverseBindMatrix,d.getInverse(b),k&&this.flipMatrixBone(d),d.getInverse(d),c.multiplyMatrices(d,c));e.setFromMatrixPosition(c);
f.setFromRotationMatrix(c);h[m]={name:l.name,pos:[e.x,e.y,e.z],rotq:[f.x,f.y,f.z,f.w],parent:l.parentIndex}}return a.tag=h}}();THREE.SEA3D.prototype.getSkeletonAnimation=function(a,b){return this.isLegacy(a)?this.getSkeletonAnimationLegacy(a,b):this._getSkeletonAnimation(a,b)};
...
var c=new Ammo.btRaycastVehicle(d,b,c),e=[];c.setCoordinateSystem(0,1,2);for(var f=0;f<a.wheel.length;f++){var g=a.wheel[f],h=c.addWheel(this.toAmmoVec3(g.pos),this.toAmmoVec3(g.dir),this.toAmmoVec3(g.axle),g.suspensionRestLength,g.radius,d,g.isFront);if(g=e[f]=g.target?g.target.tag:void 0)g.parent&&g.parent.remove(g),this.container&&this.container.add(g);h.set_m_suspensionStiffness(a.suspensionStiffness);h.set_m_wheelsDampingRelaxation(a.dampingRelaxation);h.set_m_wheelsDampingCompression(a.dampingCompression);
h.set_m_frictionSlip(a.frictionSlip)}THREE.AMMO.addVehicle(c,e);THREE.AMMO.addRigidBody(b,a.target?a.target.tag:void 0,a.offset?(new THREE.Matrix4).elements.set(a.offset):void 0,this.config.enabledPhysics);this.domain.vehicles=this.vehicles=this.vehicles||[];this.vehicles.push(this.objects["vhc/"+a.name]=a.tag=c)};
