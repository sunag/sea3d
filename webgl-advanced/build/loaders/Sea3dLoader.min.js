...
stop:function(){this.animations[this.current].stop()},clear:function(){this.animation.length=0;this.current="";this.mesh=null;this.name=""}};SEA3D.Pool=function(a,b,c){this.models=[];this.endFunction=b||function(){};this.load(a,c||!1)};
SEA3D.Pool.prototype={constructor:SEA3D.Pool,load:function(a,b){var c=new THREE.SEA3D(!0),d=this;c.onComplete=function(a){setTimeout(d.detectMesh,100,c,d)};b&&(c.parser=THREE.SEA3D.DEFAULT);c.load(a)},detectMesh:function(a,b){for(var c,d,e,f,g,h=0,k=a.meshes.length;h<k;h++){d=a.meshes[h];e=[];g=[];f=[];if(d.animations)for(c=0;c!==d.animations.length;c++)e[c]=d.animations[c].name,g[c]=d.animations[c].loop;if(d.geometry.morphTargets)for(c=0;c<d.geometry.morphTargets.length;c++)f[h]=d.geometry.morphTargets[c].name,
console.log(d.geometry.morphTargets[c].name);b.models[h]={name:d.name,geo:d.geometry,anim:e,loop:g,morph:f}}b.endFunction()},getMorphs:function(a){for(var b=[],c=this.models.length;c--;)this.models[c].name===a&&(b=this.models[c].morph);return b},getAnimations:function(a){for(var b=[],c=this.models.length;c--;)this.models[c].name===a&&(b[0]=this.models[c].anim,b[1]=this.models[c].loop);return b},getGeometry:function(a,b,c,d){for(var e,f=0,g=this.models.length;f<g;f++)this.models[f].name===a&&(e=this.models[f].geo);
b&&(void 0==e.vertices?this.scaleBufferGeometry(e,c,d):this.scaleGeometry(e,c,d));return e},scaleGeometry:function(a,b,c){b=b||1;c=c||"z";for(var d=0;d<a.vertices.length;d++){var e=a.vertices[d];e.x="x"===c?e.x*-b:e.x*b;e.y="y"===c?e.y*-b:e.y*b;e.z="z"===c?e.z*-b:e.z*b}a.computeFaceNormals();a.computeVertexNormals();a.verticesNeedUpdate=!0},scaleBufferGeometry:function(a,b,c){b=b||1;c=c||"z";for(var d=a.attributes.position,e=d.array,f=0;f<e.length;f++)e[f+0]="x"===c?e[f+0]*-b:e[f+0]*b,e[f+1]="y"===
c?e[f+1]*-b:e[f+1]*b,e[f+2]="z"===c?e[f+2]*-b:e[f+2]*b;a.computeVertexNormals();a.verticesNeedUpdate=!0;d.needsUpdate=!0}};
