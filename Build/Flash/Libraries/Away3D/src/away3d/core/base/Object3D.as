package away3d.core.base
{
	 ...
	 * To affect Rotate:
	 * <ul>
	 *    <li> set rotationX/Y/Z individually (using degrees), set rotation [all 3 angles] (using radians), or call rotateTo()</li>
	...
	public class Object3D extends NamedAssetBase
	{
		...
		/**
		 * Defines or get the scale of the 3d object as a <code>Vector3D</code>.
		 */
		 ...
		 */
		public function uniformScale(value:Number):void
		{
			_scaleX *= value;
			_scaleY *= value;
			_scaleZ *= value;
