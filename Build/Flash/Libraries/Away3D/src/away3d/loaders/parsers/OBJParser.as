package away3d.loaders.parsers
{
	...
	{
		public static const PARSE_GEOMETRY:uint = 1;
		public static const PARSE_MATERIALS:uint = 2;
		public static const PARSE_DEFAULT:uint = PARSE_GEOMETRY | PARSE_MATERIALS;
		 ...
		 */
		public function OBJParser(scale:Number = 1, config:uint=PARSE_DEFAULT)
		{
		...
		private function translateMaterialGroup(materialGroup:MaterialGroup, geometry:Geometry):void
		{
			...
			if (vertices.length > 0) {
				subs = GeomUtil.fromVectors(vertices, indices, uvs, normals);
