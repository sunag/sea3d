package away3d.animators
{
	...
	public class SkeletonAnimator extends AnimatorBase implements IAnimator
	{
		...
		public function invalidate(matrices:Boolean=true, pose:Boolean=true):void
		{
			// invalidate matrices
			_globalMatricesDirty = matrices;
			_globalPoseDirty = pose;
		...
		{
			_globalPoseDirty = false;
			
			//get global pose
			localToGlobalPose(_activeSkeletonState.getSkeletonPose(_skeleton), _globalPose, _skeleton);
		}
		
		public function updateGlobalMatrices():void
		{
			_globalMatricesDirty = false;
