package away3d.audio.drivers
{
	...
	public interface ISound3DDriver extends IEventDispatcher
	{
		...
		*/
		...
		function set offset(val : int) : void;		
		 ...
		 * for the driver.
		*/
		function play(startTime:Number=0, loops:int=int.MAX_VALUE) : void;
		...
		*/
		function updateReferenceVector(v:Vector3D, soundMixer3D:SoundMixer3D=null) : void;
	}
}