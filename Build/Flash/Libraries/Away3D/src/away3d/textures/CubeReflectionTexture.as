package away3d.textures
{
	...
	public class CubeReflectionTexture extends RenderCubeTexture
	{
		...
		{
			_renderer.backgroundR = (( c >> 16 ) & 0xFF) / 255.0;
			_renderer.backgroundG = (( c >> 8 ) & 0xFF) / 255.0;
			_renderer.backgroundB = ( c & 0xFF) / 255.0;
		}
		
		public function get backgroundColor():uint
		{
			var r:Number = _renderer.backgroundR * 255;
			var g:Number = _renderer.backgroundG * 255;
			var b:Number = _renderer.backgroundB * 255;
