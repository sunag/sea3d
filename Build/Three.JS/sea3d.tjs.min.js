...
THREE.SEA3D.AnimationHandler={crossfade:[],updates:[],update:function(a){var b,c=THREE.SEA3D.AnimationHandler.crossfade,d=THREE.SEA3D.AnimationHandler.updates;for(b=0;b<c.length;){var e=c[b],f=e.animations.length,h=1,g=Math.abs(a)/e.crossfade;for(e.blendMethod===SEA3D.AnimationBlendMethod.EASING&&(g*=e.easeSpeed);f;){var k=e.animations[--f];0<k.weight&&k!=e.currentAnimation&&(e.blendMethod===SEA3D.AnimationBlendMethod.LINEAR?k.weight-=g:e.blendMethod===SEA3D.AnimationBlendMethod.EASING&&(k.weight-=
k.weight*g),0>k.weight&&(k.weight=0),h-=k.weight)}0>h&&(h=0);e.currentAnimation.weight=h;if(1==h){if(c.splice(b,1),delete e.crossfade,e.onCrossfadeComplete)e.onCrossfadeComplete(e)}else++b}for(b=0;b<d.length;)d[b++](a);SEA3D.AnimationHandler.update(a)},addCrossfade:function(a,b){var c=THREE.SEA3D.AnimationHandler.crossfade;if(0<b)a.crossfade||c.push(a),a.crossfade=b;else{for(var d=a.animations.length;d;)a.animations[--d].weight=0;if(a.crossfade&&(c.splice(c.indexOf(a),1),delete a.crossfade,a.onCrossfadeComplete))a.onCrossfadeComplete(a);
