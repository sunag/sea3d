...
b.readAnimationList(c));this.depthWrite=0==(this.attrib&256);this.depthTest=0==(this.attrib&512);this.premultipliedAlpha=0!=(this.attrib&1024);a=b.readUByte();for(var d=0;d<a;++d){var e=b.readUShort(),g=b.readUShort(),h=b.position,f,k;switch(e){case SEA3D.Material.PHONG:f={ambientColor:b.readUInt24(),diffuseColor:b.readUInt24(),specularColor:b.readUInt24(),specular:b.readFloat(),gloss:b.readFloat()};break;case SEA3D.Material.PHYSICAL:f={color:b.readUInt24(),roughness:b.readFloat(),metalness:b.readFloat()};
break;case SEA3D.Material.ANISOTROPIC:break;case SEA3D.Material.COMPOSITE_TEXTURE:f={composite:c.getObject(b.readUInt())};break;case SEA3D.Material.DIFFUSE_MAP:f={texture:c.getObject(b.readUInt())};break;case SEA3D.Material.SPECULAR_MAP:f={texture:c.getObject(b.readUInt())};break;case SEA3D.Material.NORMAL_MAP:f={texture:c.getObject(b.readUInt())};break;case SEA3D.Material.REFLECTION:case SEA3D.Material.FRESNEL_REFLECTION:f={texture:c.getObject(b.readUInt()),alpha:b.readFloat()};e==SEA3D.Material.FRESNEL_REFLECTION&&
(f.power=b.readFloat(),f.normal=b.readFloat());break;case SEA3D.Material.REFRACTION:f={texture:c.getObject(b.readUInt()),alpha:b.readFloat(),ior:b.readFloat()};break;case SEA3D.Material.RIM:f={color:b.readUInt24(),strength:b.readFloat(),power:b.readFloat(),blendMode:b.readBlendMode()};break;case SEA3D.Material.LIGHT_MAP:f={texture:c.getObject(b.readUInt()),channel:b.readUByte(),blendMode:b.readBlendMode()};break;case SEA3D.Material.DETAIL_MAP:f={texture:c.getObject(b.readUInt()),scale:b.readFloat(),
blendMode:b.readBlendMode()};break;case SEA3D.Material.CEL:f={color:b.readUInt24(),levels:b.readUByte(),size:b.readFloat(),specularCutOff:b.readFloat(),smoothness:b.readFloat()};break;case SEA3D.Material.TRANSLUCENT:f={translucency:b.readFloat(),scattering:b.readFloat()};break;case SEA3D.Material.BLEND_NORMAL_MAP:k=b.readUByte();f={texture:c.getObject(b.readUInt()),secondaryTexture:c.getObject(b.readUInt())};k&1?(f.offsetX0=b.readFloat(),f.offsetY0=b.readFloat(),f.offsetX1=b.readFloat(),f.offsetY1=
b.readFloat()):f.offsetX0=f.offsetY0=f.offsetX1=f.offsetY1=0;f.animate=k&2;break;case SEA3D.Material.MIRROR_REFLECTION:f={texture:c.getObject(b.readUInt()),alpha:b.readFloat()};break;case SEA3D.Material.AMBIENT_MAP:f={texture:c.getObject(b.readUInt())};break;case SEA3D.Material.ALPHA_MAP:f={texture:c.getObject(b.readUInt())};break;case SEA3D.Material.EMISSIVE:f={color:b.readUInt24()};break;case SEA3D.Material.EMISSIVE_MAP:f={texture:c.getObject(b.readUInt())};break;case SEA3D.Material.ROUGHNESS_MAP:case SEA3D.Material.METALNESS_MAP:f=
