...
SEA3D.Stream.prototype.readScriptList=function(a){for(var b=[],c=this.readUByte(),d=0;d<c;){var e=this.readUByte(),f={};f.priority=e&1|e&2;if(e&4){var h=data.readUByte();f.params={};for(var g=0;g<h;g++){var l=this.readUTF8();f.params[l]=this.readObject(a)}}e&8&&(f.method=this.readUTF8());f.tag=a.getObject(this.readUInt());b[d++]=f}return b};SEA3D.Stream.prototype.readObject=function(a){return this.readToken(this.readUByte(),a)};
...
SEA3D.Object3D=function(a,b,c){this.name=a;this.data=b;this.sea=c;this.isStatic=!1;this.attrib=b.readUShort();this.attrib&1&&(this.parent=c.getObject(b.readUInt()));this.attrib&2&&(this.animations=b.readAnimationList(c));this.attrib&4&&(this.scripts=b.readScriptList(c));this.attrib&16&&(this.properties=c.getObject(b.readUInt()));this.attrib&32&&(this.isStatic=0!=(b.readUByte()&1))};SEA3D.Object3D.prototype.readTag=function(a,b,c){};
...
THREE.SEA3D.VECBUF=new THREE.Vector3;THREE.SEA3D.prototype.setShadowMap=function(a,b){a.shadowMapWidth=a.shadowMapHeight=2048;a.castShadow=!0;a.shadowDarkness=void 0!==b?b:1};THREE.SEA3D.prototype.getMesh=function(a){return this.objects["m3d/"+a]};THREE.SEA3D.prototype.getDummy=function(a){return this.objects["dmy/"+a]};THREE.SEA3D.prototype.getLine=function(a){return this.objects["line/"+a]};THREE.SEA3D.prototype.getSound3D=function(a){return this.objects["sn3d/"+a]};
...
a.tangent4&&b.addAttribute("tangent",new THREE.BufferAttribute(a.tangent4,4));a.color&&b.addAttribute("color",new THREE.BufferAttribute(a.color[0],a.numColor));a.joint&&(b.addAttribute("skinIndex",new THREE.Float32Attribute(a.joint,4)),b.addAttribute("skinWeight",new THREE.Float32Attribute(a.weight,4)));this.config.bounding&&(b.computeBoundingBox(),b.computeBoundingSphere());b.name=a.name;this.domain.geometries=this.geometries=this.geometries||[];this.geometries.push(this.objects["geo/"+a.name]=a.tag=
...
a.height,1)};
THREE.SEA3D.prototype.readMesh=function(a){var b,c,d=a.geometry.tag,e,f,h,g,l;b=0;for(c=a.modifiers?a.modifiers.length:0;b<c;b++){var k=a.modifiers[b];switch(k.type){case SEA3D.SkeletonLocal.prototype.type:f=k;d.bones=f.tag;break;case SEA3D.Morph.prototype.type:l=k,d.morphAttributes=l.tag.attribs,d.morphTargets=l.tag.targets}}b=0;for(c=a.animations?a.animations.length:0;b<c;b++)switch(k=a.animations[b],k.tag.type){case SEA3D.SkeletonAnimation.prototype.type:h=k.tag;d.animations=this.getSkeletonAnimation(h,f);
break;case SEA3D.VertexAnimation.prototype.type:g=k.tag,d.morphAttributes=g.tag.attribs,d.morphTargets=g.tag.targets,d.animations=g.tag.animations}c=void 0!=l||void 0!=g;l=l&&void 0!=l.tag.attribs.normal||g&&void 0!=g.tag.attribs.normal;if(a.material)if(1<a.material.length){e=[];for(b=0;b<a.material.length;b++)e[b]=a.material[b].tag,e[b].skinning=void 0!=f,e[b].morphTargets=c,e[b].morphNormals=l,e[b].vertexColors=a.geometry.color?THREE.VertexColors:THREE.NoColors;e=new THREE.MultiMaterial(e)}else e=
...
!0;this.domain.meshes=this.meshes=this.meshes||[];this.meshes.push(this.objects["m3d/"+a.name]=a.tag=b);this.addSceneObject(a);this.updateTransform(b,a);this.applyDefaultAnimation(a,THREE.SEA3D.Object3DAnimator)};
