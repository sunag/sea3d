...
SEA3D.Stream.prototype.readUInt24=function(){return this.readUShort()|this.readUByte()<<16};SEA3D.Stream.prototype.readInt=function(){var a=this.data.getInt32(this.position,!0);this.position+=4;return a};SEA3D.Stream.prototype.readUInt=function(){var a=this.data.getUint32(this.position,!0);this.position+=4;return a};SEA3D.Stream.prototype.readFloat=function(){var a=this.data.getFloat32(this.position,!0);this.position+=4;return a};
...
SEA3D.Stream.prototype.readExt=function(){return this.readUTF(4).replace(/\0/g,"")};SEA3D.Stream.prototype.readUTF8=function(){return this.readUTF(this.readUByte())};SEA3D.Stream.prototype.readUTF8Short=function(){return this.readUTF(this.readUShort())};SEA3D.Stream.prototype.readUTF8Long=function(){return this.readUTF(this.readUInt())};SEA3D.Stream.prototype.readUShortArray=function(a){var b=new Uint16Array(a);a*=2;SEA3D.Stream.memcpy(b.buffer,0,this.buffer,this.position,a);this.position+=a;return b};
SEA3D.Stream.prototype.readUIntArray=function(a){var b=new Uint32Array(a);a*=2;SEA3D.Stream.memcpy(b.buffer,0,this.buffer,this.position,a);this.position+=a;return b};SEA3D.Stream.prototype.readFloatArray=function(a){var b=new Float32Array(a);a*=4;SEA3D.Stream.memcpy(b.buffer,0,this.buffer,this.position,a);this.position+=a;return b};SEA3D.Stream.prototype.readBlendMode=function(){return SEA3D.Stream.BLEND_MODE[this.readUByte()]};SEA3D.Stream.prototype.readInterpolation=function(){return SEA3D.Stream.INTERPOLATION_TABLE[this.readUByte()]};
SEA3D.Stream.prototype.toBase64=function(){return SEA3D.Stream.bufferToBase64(this.data)};SEA3D.Stream.prototype.readTags=function(a){for(var b=this.readUByte(),c=0;c<b;++c){var d=this.readUShort(),e=this.readUInt(),f=this.position;a(d,data,e);this.position=f+e}};SEA3D.Stream.prototype.readProperties=function(a){var b=this.readUByte(),c={},d={};c.__type=d;for(var e=0;e<b;e++){var f=this.readUTF8(),h=this.readUByte();c[f]=this.readToken(h,a);d[f]=h}return c};
...
SEA3D.Stream.prototype.append=function(a){var b=new ArrayBuffer(this.data.byteLength+a.byteLength);b.set(new ArrayBuffer(this.data),0);b.set(new ArrayBuffer(a),this.data.byteLength);this.data=b};SEA3D.Stream.prototype.concat=function(a,b){return new SEA3D.Stream(this.buffer.slice(a,a+b))};SEA3D.Stream.memcpy=function(a,b,c,d,e){a=new Uint8Array(a,b,e);c=new Uint8Array(c,d,e);a.set(c)};SEA3D.Math={DEGREES:180/Math.PI,RADIANS:Math.PI/180};
SEA3D.Math.angle=function(a){var b=0>a;a=(b?-a:a)%360;180<a&&(a=-180+(a-180));return b?-a:a};SEA3D.Math.lerpAngle=function(a,b,c){180<Math.abs(a-b)&&(b=a>b?b+360:b-360);return SEA3D.Math.angle(a+(b-a)*c)};SEA3D.Math.lerpColor=function(a,b,c){var d=a>>24&255,e=a>>16&255,f=a>>8&255;a&=255;e+=((b>>16&255)-e)*c;f+=((b>>8&255)-f)*c;a+=((b&255)-a)*c;return d+((b>>24&255)-d)*c<<24|e<<16|f<<8|a};SEA3D.Math.lerp=function(a,b,c){return a+(b-a)*c};SEA3D.Math.lerp1x=function(a,b,c){a[0]+=(b[0]-a[0])*c};
SEA3D.Math.lerp3x=function(a,b,c){a[0]+=(b[0]-a[0])*c;a[1]+=(b[1]-a[1])*c;a[2]+=(b[2]-a[2])*c};SEA3D.Math.lerpAng1x=function(a,b,c){a[0]=SEA3D.Math.lerpAngle(a[0],b[0],c)};SEA3D.Math.lerpColor1x=function(a,b,c){a[0]=SEA3D.Math.lerpColor(a[0],b[0],c)};SEA3D.Math.lerpQuat4x=function(a,b,c){var d=a[0],e=a[1],f=a[2],h=a[3],g=b[0],l=b[1],k=b[2];b=b[3];0>d*g+e*l+f*k+h*b&&(g=-g,l=-l,k=-k,b=-b);d+=c*(g-d);e+=c*(l-e);f+=c*(k-f);c=h+c*(b-h);h=1/Math.sqrt(c*c+d*d+e*e+f*f);a[0]=d*h;a[1]=e*h;a[2]=f*h;a[3]=c*h};
...
SEA3D.Geometry=function(a,b,c){SEA3D.GeometryBase.call(this,a,b,c);var d,e;this.attrib&4&&(this.normal=b.readFloatArray(this.length));this.attrib&8&&(this.tangent=b.readFloatArray(this.length));if(this.attrib&32)for(this.uv=[],this.uv.length=b.readUByte(),e=2*this.numVertex,a=0;a<this.uv.length;)this.uv[a++]=b.readFloatArray(e);this.attrib&64&&(this.jointPerVertex=b.readUByte(),a=this.numVertex*this.jointPerVertex,this.joint=b.readUShortArray(a),this.weight=b.readFloatArray(a));if(this.attrib&128)for(c=
b.readUByte(),this.numColor=((c&64)>>6|(c&128)>>6)+1,this.color=[],a=0,e=c&15;a<e;a++)this.color.push(b.readFloatArray(this.numVertex*this.numColor));this.vertex=b.readFloatArray(this.length);var f=b.readUByte();this.groups=[];if(this.attrib&2){for(a=e=0;a<f;a++)this.groups.push({start:3*b.readVInt(),count:e+=3*b.readVInt()});this.indexes=this.isBig?b.readUIntArray(e):b.readUShortArray(e)}else{c=0;d=[];for(a=0;a<f;a++)for(e=3*b.readVInt(),this.groups.push({start:c,count:e}),e+=c;c<e;)d[c++]=b.readVInt();
this.indexes=this.isBig?new Uint32Array(d):new Uint16Array(d)}};SEA3D.Geometry.prototype=Object.create(SEA3D.GeometryBase.prototype);SEA3D.Geometry.prototype.constructor=SEA3D.Geometry;SEA3D.Geometry.prototype.type="geo";
...
b.readUByte(),this.numColor=((c&64)>>6|(c&128)>>6)+1,this.color=[],a=0,c&=15;a<c;a++)this.color.push(b.readFloatArray(this.numVertex*this.numColor));this.vertex=b.readFloatArray(this.length);var d=b.readUByte();this.indexes=new Uint16Array;this.groups=[];for(a=j=0;a<d;a++)for(c=3*b.readVInt(),this.groups.push({start:j,count:c}),c+=j;j<c;)vec[j++]=b.readVInt()};SEA3D.Geometry16.prototype=Object.create(SEA3D.GeometryBase.prototype);SEA3D.Geometry16.prototype.constructor=SEA3D.Geometry16;
SEA3D.Geometry16.prototype.type="ge16";SEA3D.GeometryDeltaBase=function(a,b,c){this.name=a;this.data=b;this.sea=c;this.attrib=b.readUShort();this.numVertex=b.readUInteger();this.length=3*this.numVertex;this.attrib&1?(b.readNumber=b.readByte,this.numDiv=127.5):(b.readNumber=b.readShort,numDiv=32767.5)};
...
this.addClass(SEA3D.Properties);this.addClass(SEA3D.TextureURL,!0);this.addClass(SEA3D.Sphere);this.addClass(SEA3D.Box);this.addClass(SEA3D.Cone);this.addClass(SEA3D.Capsule);this.addClass(SEA3D.Cylinder);this.addClass(SEA3D.GeometryShape);this.addClass(SEA3D.StaticGeometryShape);this.addClass(SEA3D.RigidBody);this.addClass(SEA3D.P2PConstraint);this.addClass(SEA3D.HingeConstraint);this.addClass(SEA3D.ConeTwistConstraint);this.addClass(SEA3D.CarController);this.addClass(SEA3D.JPEG,!0);this.addClass(SEA3D.JPEG_XR,
!0);this.addClass(SEA3D.PNG,!0);this.addClass(SEA3D.GIF,!0);this.addClass(SEA3D.OGG,!0);this.addClass(SEA3D.MP3,!0);this.addClass(SEA3D.JavaScript,!0);this.addClass(SEA3D.JavaScriptMethod,!0);this.addClass(SEA3D.GLSL,!0)};SEA3D.File.CompressionLibs={};SEA3D.File.DecompressionMethod={};SEA3D.File.setDecompressionEngine=function(a,b,c){SEA3D.File.CompressionLibs[a]=b;SEA3D.File.DecompressionMethod[a]=c};
...
0;b<THREE.SEA3D.EXTENSIONS.length;b++)THREE.SEA3D.EXTENSIONS[b].call(this);this.file.read(a)};
