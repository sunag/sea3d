...
THREE.SEA3D.prototype.readCamera=function(a){var b=new THREE.PerspectiveCamera(a.fov);b.name=a.name;this.domain.cameras=this.cameras=this.camera||[];this.cameras.push(this.objects["cam/"+a.name]=a.tag=b);this.addSceneObject(a);this.updateTransform(b,a);this.applyDefaultAnimation(a,THREE.SEA3D.CameraAnimator)};
