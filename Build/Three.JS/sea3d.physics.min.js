...
e),h.position.setFromMatrixPosition(a),h.quaternion.setFromRotationMatrix(a)):(h.position.set(g.x(),g.y(),g.z()),h.quaternion.set(f.x(),f.y(),f.z(),f.w()));return this}}(),update:function(a,b,c){this.world.stepSimulation(a,b||0,c||.06);for(a=0;a<this.vehicles.length;a++){c=this.vehicles[a];var d=c.getNumWheels(),h=this.vehiclesWheels[a];for(b=0;b<d;b++){c.updateWheelTransform(b,!0);var f=c.getWheelTransformWS(b),e=h[b];e&&this.updateTargetTransform(e,f,e.physics?e.physics.offset:null)}}for(a=0;a<
