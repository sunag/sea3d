...
setGravity:function(a){this.gravity=a;this.world.setGravity(new Ammo.btVector3(0,a,0));return this},getGravity:function(){return this.gravity},setEnabledRigidBody:function(a,b){if(this.getEnabledRigidBody(a)!=b)return b?this.world.addRigidBody(a):this.world.removeRigidBody(a),this},getEnabledRigidBody:function(a){return!0===this.rigidBodiesEnabled[this.rigidBodies.indexOf(a)]},addRigidBody:function(a,b,c,d){d=void 0!==d?d:!0;this.rigidBodies.push(a);this.rigidBodiesTarget.push(b);this.rigidBodiesOffset.push(c);
this.rigidBodiesEnabled.push(!1);this.setEnabledRigidBody(a,d);return this},removeRigidBody:function(a,b){var c=this.rigidBodies.indexOf(a);this.setEnabledRigidBody(a,!1);this.rigidBodies.splice(c,1);this.rigidBodiesTarget.splice(c,1);this.rigidBodiesOffset.splice(c,1);this.rigidBodiesEnabled.splice(c,1);b&&Ammo.destroy(a);return this},containsRigidBody:function(a){return-1<this.rigidBodies.indexOf(a)},addConstraint:function(a,b){b=void 0==b?!0:b;this.constraints.push(a);this.world.addConstraint(a,
b);return this},removeConstraint:function(a,b){this.constraints.splice(this.constraints.indexOf(a),1);this.world.removeConstraint(a);b&&Ammo.destroy(a);return this},containsConstraint:function(a){return-1<this.constraints.indexOf(rb)},addVehicle:function(a,b){this.vehicles.push(a);this.vehiclesWheels.push(void 0!=b?b:[]);this.world.addAction(a);return this},removeVehicle:function(a,b){var c=this.vehicles.indexOf(a);this.vehicles.splice(c,1);this.vehiclesWheels.splice(c,1);this.world.removeAction(a);
b&&Ammo.destroy(a);return this},containsVehicle:function(a){return-1<this.vehicles.indexOf(a)},createTriangleMesh:function(a,b,c){b=void 0==b?-1:b;c=void 0==c?!1:c;var d=new Ammo.btTriangleMesh,h=new Ammo.btVector3(0,0,0),f=new Ammo.btVector3(0,0,0),e=new Ammo.btVector3(0,0,0),g=a.getAttribute("position").array,k=a.getIndex().array,l=0<=b?a.groups[b]:void 0;a=l?l.count:k.length;b=1/this.worldScale;for(l=l?l.start:0;l<a;l+=3){var m=3*k[l],n=3*k[l+1],p=3*k[l+2];h.setValue(g[m]*b,g[m+1]*b,g[m+2]*b);
f.setValue(g[n]*b,g[n+1]*b,g[n+2]*b);e.setValue(g[p]*b,g[p+1]*b,g[p+2]*b);d.addTriangle(h,f,e,c)}return d},createConvexHull:function(a,b){b=void 0==b?-1:b;var c=new Ammo.btConvexHullShape;new Ammo.btVector3(0,0,0);for(var d=a.getAttribute("position").array,h=a.getIndex().array,f=0<=b?a.groups[b]:void 0,e=f?f.count:h.length,g=1/this.worldScale,f=f?f.start:0;f<e;f+=3){var k=3*h[f],k=new Ammo.btVector3(d[k]*g,d[k+1]*g,d[k+2]*g);c.addPoint(k)}return c},getTargetByRigidBody:function(a){return this.rigidBodiesTarget[this.rigidBodies.indexOf(a)]},
...
new THREE.Vector3,c=new THREE.Quaternion,d=new THREE.Vector3(1,1,1);return function(a,f){f=f||new THREE.Matrix4;var e=a.getOrigin(),g=a.getRotation();b.set(e.x(),e.y(),e.z());c.set(g.x(),g.y(),g.z(),g.w());f.compose(b,c,d);return f}}(),updateTargetTransform:function(){var a=new THREE.Matrix4,b=new THREE.Vector3,c=new THREE.Quaternion,d=new THREE.Vector3(1,1,1);return function(h,f,e){var g=f.getOrigin();f=f.getRotation();void 0==e?(h.position.set(g.x(),g.y(),g.z()),h.quaternion.set(f.x(),f.y(),f.z(),
f.w())):(b.set(g.x(),g.y(),g.z()),c.set(f.x(),f.y(),f.z(),f.w()),a.compose(b,c,d),a.multiplyMatrices(a,e),h.position.setFromMatrixPosition(a),h.quaternion.setFromRotationMatrix(a));return this}}(),update:function(a,b,c){this.world.stepSimulation(a,b||0,c||.06);for(a=0;a<this.vehicles.length;a++){c=this.vehicles[a];var d=c.getNumWheels(),h=this.vehiclesWheels[a];for(b=0;b<d;b++){c.updateWheelTransform(b,!0);var f=c.getWheelTransformWS(b),e=h[b];e&&this.updateTargetTransform(e,f)}}for(a=0;a<this.rigidBodies.length;a++)b=
this.rigidBodies[a],c=this.rigidBodiesTarget[a],d=this.rigidBodiesOffset[a],c&&b.isActive()&&this.updateTargetTransform(c,b.getWorldTransform(),d);return this}};THREE.SEA3D.prototype.toAmmoVec3=function(a){return new Ammo.btVector3(a.x,a.y,a.z)};THREE.SEA3D.prototype.readSphere=function(a){var b=new Ammo.btSphereShape(a.radius);this.domain.shapes=this.shapes=this.shapes||[];this.shapes.push(this.objects["shpe/"+a.name]=a.tag=b)};THREE.SEA3D.prototype.readBox=function(a){var b=new Ammo.btBoxShape(new Ammo.btVector3(.5*a.width,.5*a.height,.5*a.depth));this.domain.shapes=this.shapes=this.shapes||[];this.shapes.push(this.objects["shpe/"+a.name]=a.tag=b)};
...
var c=new Ammo.btRaycastVehicle(d,b,c),h=[];c.setCoordinateSystem(0,1,2);for(var f=0;f<a.wheel.length;f++){var e=a.wheel[f],g=c.addWheel(this.toAmmoVec3(e.pos),this.toAmmoVec3(e.dir),this.toAmmoVec3(e.axle),e.suspensionRestLength,e.radius,d,e.isFront);if(e=h[f]=e.target?e.target.tag:void 0)e.parent&&e.parent.remove(e),this.container&&this.container.add(e);g.set_m_suspensionStiffness(a.suspensionStiffness);g.set_m_wheelsDampingRelaxation(a.dampingRelaxation);g.set_m_wheelsDampingCompression(a.dampingCompression);
g.set_m_frictionSlip(a.frictionSlip)}SEA3D.AMMO.addVehicle(c,h);SEA3D.AMMO.addRigidBody(b,a.target?a.target.tag:void 0,a.offset?(new THREE.Matrix4).elements.set(a.offset):void 0,this.config.enabledPhysics);this.domain.vehicles=this.vehicles=this.vehicles||[];this.vehicles.push(this.objects["vhc/"+a.name]=a.tag=c)};
