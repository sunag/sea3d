...
SEA3D.Stream.prototype.readInterpolation=function(){return SEA3D.Stream.INTERPOLATION_TABLE[this.readUByte()]};SEA3D.Stream.prototype.readTags=function(a){for(var b=this.readUByte(),c=0;c<b;++c){var d=this.readUShort(),e=this.readUInt(),g=this.position;a(d,this,e);this.position=g+e}};
SEA3D.Stream.prototype.readProperties=function(a){var b=this.readUByte(),c={},d={};c.__type=d;for(var e=0;e<b;e++){var g=this.readUTF8Tiny(),h=this.readUByte();d[g]=h;c[g]=h===SEA3D.Stream.GROUP?this.readProperties(a):this.readToken(h,a)}return c};SEA3D.Stream.prototype.readAnimationList=function(a){for(var b=[],c=this.readUByte(),d=0;d<c;){var e=this.readUByte(),g={};g.relative=0!=(e&1);e&2&&(g.timeScale=this.readFloat());g.tag=a.getObject(this.readUInt());b[d++]=g}return b};
...
this.depthWrite=0===(this.attrib&256);this.depthTest=0===(this.attrib&512);this.premultipliedAlpha=0!=(this.attrib&1024);a=b.readUByte();for(var d=0;d<a;++d){var e=b.readUShort(),g=b.readUShort(),h=b.position,f,k;switch(e){case SEA3D.Material.PHONG:f={ambientColor:b.readUInt24(),diffuseColor:b.readUInt24(),specularColor:b.readUInt24(),specular:b.readFloat(),gloss:b.readFloat()};break;case SEA3D.Material.PHYSICAL:f={color:b.readUInt24(),roughness:b.readFloat(),metalness:b.readFloat()};break;case SEA3D.Material.ANISOTROPIC:break;
case SEA3D.Material.COMPOSITE_TEXTURE:f={composite:c.getObject(b.readUInt())};break;case SEA3D.Material.DIFFUSE_MAP:case SEA3D.Material.SPECULAR_MAP:case SEA3D.Material.NORMAL_MAP:case SEA3D.Material.AMBIENT_MAP:case SEA3D.Material.ALPHA_MAP:case SEA3D.Material.EMISSIVE_MAP:case SEA3D.Material.ROUGHNESS_MAP:case SEA3D.Material.METALNESS_MAP:f={texture:c.getObject(b.readUInt())};break;case SEA3D.Material.REFLECTION:case SEA3D.Material.FRESNEL_REFLECTION:f={texture:c.getObject(b.readUInt()),alpha:b.readFloat()};
e===SEA3D.Material.FRESNEL_REFLECTION&&(f.power=b.readFloat(),f.normal=b.readFloat());break;case SEA3D.Material.REFRACTION:f={texture:c.getObject(b.readUInt()),alpha:b.readFloat(),ior:b.readFloat()};break;case SEA3D.Material.RIM:f={color:b.readUInt24(),strength:b.readFloat(),power:b.readFloat(),blendMode:b.readBlendMode()};break;case SEA3D.Material.LIGHT_MAP:f={texture:c.getObject(b.readUInt()),channel:b.readUByte(),blendMode:b.readBlendMode()};break;case SEA3D.Material.DETAIL_MAP:f={texture:c.getObject(b.readUInt()),
scale:b.readFloat(),blendMode:b.readBlendMode()};break;case SEA3D.Material.CEL:f={color:b.readUInt24(),levels:b.readUByte(),size:b.readFloat(),specularCutOff:b.readFloat(),smoothness:b.readFloat()};break;case SEA3D.Material.TRANSLUCENT:f={translucency:b.readFloat(),scattering:b.readFloat()};break;case SEA3D.Material.BLEND_NORMAL_MAP:k=b.readUByte();f={texture:c.getObject(b.readUInt()),secondaryTexture:c.getObject(b.readUInt())};k&1?(f.offsetX0=b.readFloat(),f.offsetY0=b.readFloat(),f.offsetX1=b.readFloat(),
f.offsetY1=b.readFloat()):f.offsetX0=f.offsetY0=f.offsetX1=f.offsetY1=0;f.animate=k&2;break;case SEA3D.Material.MIRROR_REFLECTION:f={texture:c.getObject(b.readUInt()),alpha:b.readFloat()};break;case SEA3D.Material.EMISSIVE:f={color:b.readUInt24F()};break;case SEA3D.Material.VERTEX_COLOR:f={blendMode:b.readBlendMode()};break;case SEA3D.Material.WRAP_LIGHTING:f={color:b.readUInt24(),strength:b.readFloat()};break;case SEA3D.Material.COLOR_REPLACE:k=b.readUByte();f={red:b.readUInt24(),green:b.readUInt24(),
blue:b.readUInt24F()};k&1&&(f.mask=c.getObject(b.readUInt()));k&2&&(f.alpha=b.readFloat());break;case SEA3D.Material.REFLECTION_SPHERICAL:f={texture:c.getObject(b.readUInt()),alpha:b.readFloat()};break;case SEA3D.Material.REFLECTIVITY:k=b.readUByte();f={strength:b.readFloat()};k&1&&(f.mask=c.getObject(b.readUInt()));break;case SEA3D.Material.CLEAR_COAT:f={strength:b.readFloat(),roughness:b.readFloat()};break;case SEA3D.Material.FLACCIDITY:k=b.readUByte();f={target:c.getObject(b.readUInt()),scale:b.readFloat(),
spring:b.readFloat(),damping:b.readFloat()};k&1&&(f.mask=c.getObject(b.readUInt()));break;default:console.warn("SEA3D: MaterialTechnique not found:",e.toString(16));b.position=h+g;continue}f.kind=e;this.technique.push(f);this.tecniquesDict[e]=f;b.position=h+g}};SEA3D.Material.PHONG=0;SEA3D.Material.COMPOSITE_TEXTURE=1;SEA3D.Material.DIFFUSE_MAP=2;SEA3D.Material.SPECULAR_MAP=3;SEA3D.Material.REFLECTION=4;SEA3D.Material.REFRACTION=5;SEA3D.Material.NORMAL_MAP=6;SEA3D.Material.FRESNEL_REFLECTION=7;
...
this._rangeDecoder.init()};a.Decoder.prototype.decode=function(b,c,d){var e=0,g=0,h=0,f=0,k=0,n=0,l=0;this._rangeDecoder.setStream(b);this._outWindow.setStream(c);for(this.init();0>d||n<d;)if(b=n&this._posStateMask,0===this._rangeDecoder.decodeBit(this._isMatchDecoders,(e<<4)+b))l=this._literalDecoder.getDecoder(n++,l),l=7<=e?l.decodeWithMatchByte(this._rangeDecoder,this._outWindow.getByte(g)):l.decodeNormal(this._rangeDecoder),this._outWindow.putByte(l),e=4>e?0:e-(10>e?3:6);else{if(1===this._rangeDecoder.decodeBit(this._isRepDecoders,
e))l=0,0===this._rangeDecoder.decodeBit(this._isRepG0Decoders,e)?0===this._rangeDecoder.decodeBit(this._isRep0LongDecoders,(e<<4)+b)&&(e=7>e?9:11,l=1):(0===this._rangeDecoder.decodeBit(this._isRepG1Decoders,e)?c=h:(0===this._rangeDecoder.decodeBit(this._isRepG2Decoders,e)?c=f:(c=k,k=f),f=h),h=g,g=c),0===l&&(l=2+this._repLenDecoder.decode(this._rangeDecoder,b),e=7>e?8:11);else if(k=f,f=h,h=g,l=2+this._lenDecoder.decode(this._rangeDecoder,b),e=7>e?7:10,b=this._posSlotDecoder[5>=l?l-2:3].decode(this._rangeDecoder),
4<=b)if(c=(b>>1)-1,g=(2|b&1)<<c,14>b)g+=a.reverseDecode2(this._posDecoders,g-b-1,this._rangeDecoder,c);else{if(g+=this._rangeDecoder.decodeDirectBits(c-4)<<4,g+=this._posAlignDecoder.reverseDecode(this._rangeDecoder),0>g){if(-1===g)break;return!1}}else g=b;if(g>=n||g>=this._dictionarySizeCheck)return!1;this._outWindow.copyBlock(g,l);n+=l;l=this._outWindow.getByte(0)}this._outWindow.flush();this._outWindow.releaseStream();this._rangeDecoder.releaseStream();return!0};a.Decoder.prototype.setDecoderProperties=
...
THREE.SEA3D.prototype.addDefaultAnimation=function(a,b){for(var c=a.tag,d=0,e=a.animations?a.animations.length:0;d<e;d++){var g=a.animations[d];switch(g.tag.type){case SEA3D.Animation.prototype.type:return d=g.tag.tag||this.getModifier({sea:g.tag,scope:c,relative:g.relative}),c.animator=new b(d,c),c.animator.setRelative(g.relative),this.config.autoPlay&&c.animator.play(0),c.animator}}};
...
THREE.SEA3D.prototype.readMesh=function(a){var b,c,d=a.geometry.tag,e,g,h,f,k,n,l;b=0;for(c=a.modifiers?a.modifiers.length:0;b<c;b++){var m=a.modifiers[b];switch(m.type){case SEA3D.Skeleton.prototype.type:case SEA3D.SkeletonLocal.prototype.type:g=m;d.bones=g.tag;break;case SEA3D.Morph.prototype.type:h=m.tag||this.getModifier({sea:m,geometry:a.geometry}),d.morphAttributes=h.attribs,d.morphTargets=h.targets}}b=0;for(c=a.animations?a.animations.length:0;b<c;b++)switch(m=a.animations[b].tag,m.type){case SEA3D.SkeletonAnimation.prototype.type:f=
m;d.animations=f.tag||this.getModifier({sea:f,skeleton:g,relative:!0});break;case SEA3D.VertexAnimation.prototype.type:k=m;d.morphAttributes=k.tag.attribs;d.morphTargets=k.tag.targets;d.animations=k.tag.animations;break;case SEA3D.UVWAnimation.prototype.type:n=m.tag||this.getModifier({sea:m});break;case SEA3D.MorphAnimation.prototype.type:l=m.tag||this.getModifier({sea:m})}c=void 0!=h||void 0!=k;h=h&&void 0!=h.attribs.normal||k&&void 0!=k.tag.attribs.normal;if(a.material)if(1<a.material.length)for(m=
[],b=0;b<a.material.length;b++)m[b]=a.material[b].tag,m[b].skinning=void 0!=g,m[b].morphTargets=c,m[b].morphNormals=h,m[b].vertexColors=a.geometry.color?THREE.VertexColors:THREE.NoColors;else e=a.material[0].tag,e.skinning=void 0!=g,e.morphTargets=c,e.morphNormals=h,e.vertexColors=a.geometry.color?THREE.VertexColors:THREE.NoColors;g?(b=new THREE.SEA3D.SkinnedMesh(d,e,this.config.useVertexTexture),this.config.autoPlay&&f&&b.play(0)):k?(b=new THREE.SEA3D.VertexAnimationMesh(d,e),this.config.autoPlay&&
b.play(0)):b=new THREE.SEA3D.Mesh(d,e);n&&(b.uvwAnimator=new THREE.SEA3D.Animator(n,new THREE.AnimationMixer(e.map)),this.config.autoPlay&&b.uvwAnimator.play(0));l&&(b.morphAnimator=new THREE.SEA3D.Animator(l,new THREE.AnimationMixer(b)),this.config.autoPlay&&b.morphAnimator.play(0));b.name=a.name;b.castShadow=a.castShadows;b.receiveShadow=a.material?a.material[0].receiveShadows:!0;this.domain.meshes=this.meshes=this.meshes||[];this.meshes.push(this.objects["m3d/"+a.name]=a.tag=b);this.addSceneObject(a);
...
THREE.SEA3D.prototype.readCubeMap=function(a){var b=this.toFaces(a.faces),c=new THREE.CubeTexture([]),d=0;c.name=a.name;c.flipY=!1;c.format=THREE.RGBFormat;for(var e=function(){6===++d&&(c.needsUpdate=!0,this.config.async||(this.file.resume=!0))}.bind(this),g=0;g<b.length;++g){var h=new Image;h.onload=e;h.src=this.createObjectURL(b[g].buffer,"image/"+a.extension);c.images[g]=h}this.config.async||(this.file.resume=!1);this.domain.cubemaps=this.cubemaps=this.cubemaps||[];this.cubemaps.push(this.objects["cmap/"+
...
a);this.addDefaultAnimation(a,THREE.SEA3D.CameraAnimator)};THREE.SEA3D.prototype.getSkeletonFromBones=function(a){var b=[],c,d,e,g;e=0;for(g=a.length;e<g;e++)d=a[e],c=new THREE.Bone,b.push(c),c.name=d.name,c.position.fromArray(d.pos),c.quaternion.fromArray(d.rotq),void 0!==d.scl&&c.scale.fromArray(d.scl);e=0;for(g=a.length;e<g;e++)d=a[e],-1!==d.parent&&null!==d.parent&&void 0!==b[d.parent]&&b[d.parent].add(b[e]);return new THREE.Skeleton(b)};
...
THREE.SEA3D.prototype.readAnimation=function(a){for(var b=[],c=1E3/a.frameRate/1E3,d=0;d<a.sequence.length;d++){for(var e=a.sequence[d],g=[],h=0;h<a.dataList.length;h++){var f=a.dataList[h],k,n,l,m=f.data;l=e.start*f.blockSize;k=l+e.count*f.blockSize;var q=e.intrpl?THREE.InterpolateLinear:!1,p=null;switch(f.kind){case SEA3D.Animation.POSITION:p=".position";break;case SEA3D.Animation.ROTATION:p=".quaternion";break;case SEA3D.Animation.SCALE:p=".scale";break;case SEA3D.Animation.COLOR:p=".color";break;
case SEA3D.Animation.MULTIPLIER:p=".intensity";break;case SEA3D.Animation.FOV:p=".fov";break;case SEA3D.Animation.OFFSET_U:p=".offset[x]";break;case SEA3D.Animation.OFFSET_V:p=".offset[y]";break;case SEA3D.Animation.SCALE_U:p=".repeat[x]";break;case SEA3D.Animation.SCALE_V:p=".repeat[y]";break;case SEA3D.Animation.RADIAN:p=".rotation";break;case SEA3D.Animation.MORPH:p=".morphTargetInfluences["+f.name+"]"}if(p)switch(f.type){case SEA3D.Stream.BYTE:case SEA3D.Stream.UBYTE:case SEA3D.Stream.INT:case SEA3D.Stream.UINT:case SEA3D.Stream.FLOAT:case SEA3D.Stream.DOUBLE:case SEA3D.Stream.DECIMAL:l=
m.subarray(l,k);n=new Float32Array(l.length);for(k=f=0;k<n.length;k++)n[k]=f,f+=c;g.push(new THREE.NumberKeyframeTrack(p,n,l,q));break;case SEA3D.Stream.VECTOR3D:l=m.subarray(l,k);n=new Float32Array(l.length/f.blockSize);for(k=f=0;k<n.length;k++)n[k]=f,f+=c;g.push(new THREE.VectorKeyframeTrack(p,n,l,q));break;case SEA3D.Stream.VECTOR4D:l=m.subarray(l,k);n=new Float32Array(l.length/f.blockSize);for(k=f=0;k<n.length;k++)n[k]=f,f+=c;g.push(new THREE.QuaternionKeyframeTrack(p,n,l,q));break;case SEA3D.Stream.INT24:case SEA3D.Stream.UINT24:l=
new Float32Array(3*(k-l));n=new Float32Array(l.length/3);for(k=f=0;k<n.length;k++)l[3*k]=(m[k]>>16&255)/255,l[3*k+1]=(m[k]>>8&255)/255,l[3*k+2]=(m[k]&255)/255,n[k]=f,f+=c;g.push(new THREE.VectorKeyframeTrack(p,n,l,q))}}b.push(new THREE.SEA3D.AnimationClip(e.name,-1,g,e.repeat))}this.domain.clips=this.clips=this.clips||[];this.clips.push(this.objects[a.name+".anm"]=a.tag=b)};
THREE.SEA3D.prototype.readSkeletonAnimation=function(a,b){b=!b&&a.metadata&&a.metadata.skeleton?a.metadata.skeleton:b;if(!b||a.tag)return a.tag;for(var c=[],d=1E3/a.frameRate/1E3,e=0;e<a.sequence.length;e++){for(var g=a.sequence[e],h=g.start,f=h+g.count,k={name:g.name,fps:a.frameRate,length:d*g.count,hierarchy:[]},n=a.numJoints,l=a.raw,m=0;m<n;m++){for(var q={parent:b.joint[m].parentIndex,keys:[]},p=q.keys,u=0,t=h;t<f;t++){var r=t*n*7+7*m;p.push({time:u,pos:[l[r],l[r+1],l[r+2]],rot:[l[r+3],l[r+4],
l[r+5],l[r+6]],scl:[1,1,1]});u+=d}k.hierarchy[m]=q}c.push(THREE.SEA3D.AnimationClip.fromClip(THREE.AnimationClip.parseAnimation(k,b.tag),g.repeat))}this.domain.clips=this.clips=this.clips||[];this.clips.push(this.objects[a.name+".skla"]=a.tag=c)};
