...
THREE.SEA3D.prototype.readMesh=function(a){var b,c,d=a.geometry.tag,e,g,h,f,k,m,l;b=0;for(c=a.modifiers?a.modifiers.length:0;b<c;b++){var n=a.modifiers[b];switch(n.type){case SEA3D.Skeleton.prototype.type:case SEA3D.SkeletonLocal.prototype.type:g=n;d.bones=g.tag;break;case SEA3D.Morph.prototype.type:h=n,d.morphAttributes=h.tag.attribs,d.morphTargets=h.tag.targets}}b=0;for(c=a.animations?a.animations.length:0;b<c;b++)switch(n=a.animations[b].tag,n.type){case SEA3D.SkeletonAnimation.prototype.type:f=n;
d.animations=f.tag||this.getAnimationType({sea:f,skeleton:g,relative:!0});break;case SEA3D.VertexAnimation.prototype.type:k=n;d.morphAttributes=k.tag.attribs;d.morphTargets=k.tag.targets;d.animations=k.tag.animations;break;case SEA3D.UVWAnimation.prototype.type:m=n.tag||this.getAnimationType({sea:n});break;case SEA3D.MorphAnimation.prototype.type:l=n.tag||this.getAnimationType({sea:n})}c=void 0!=h||void 0!=k;h=h&&void 0!=h.tag.attribs.normal||k&&void 0!=k.tag.attribs.normal;if(a.material)if(1<a.material.length){e=
[];for(b=0;b<a.material.length;b++)e[b]=a.material[b].tag,e[b].skinning=void 0!=g,e[b].morphTargets=c,e[b].morphNormals=h,e[b].vertexColors=a.geometry.color?THREE.VertexColors:THREE.NoColors;e=THREE.SEA3D.useMultiMaterial?new THREE.MultiMaterial(e):e}else e=a.material[0].tag,e.skinning=void 0!=g,e.morphTargets=c,e.morphNormals=h,e.vertexColors=a.geometry.color?THREE.VertexColors:THREE.NoColors;g?(b=new THREE.SEA3D.SkinnedMesh(d,e,this.config.useVertexTexture),this.config.autoPlay&&f&&b.play(0)):k?
(b=new THREE.SEA3D.VertexAnimationMesh(d,e),this.config.autoPlay&&b.play(0)):b=new THREE.SEA3D.Mesh(d,e);m&&(b.uvwAnimator=new THREE.SEA3D.Animator(m,new THREE.AnimationMixer(e.map)),this.config.autoPlay&&b.uvwAnimator.play(0));l&&(b.morphAnimator=new THREE.SEA3D.Animator(l,new THREE.AnimationMixer(b)),this.config.autoPlay&&b.morphAnimator.play(0));b.name=a.name;b.castShadow=a.castShadows;b.receiveShadow=a.material?a.material[0].receiveShadows:!0;this.domain.meshes=this.meshes=this.meshes||[];this.meshes.push(this.objects["m3d/"+
